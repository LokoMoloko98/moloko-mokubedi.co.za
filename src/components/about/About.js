      ...
      <div className="about-content">
        <Fade duration={1000}>
          <div className="about-text">
            ...
            <p>
              😁 I am someone who is constantly dedicated to growth and improvement, committed to staying up-to-date with industry trends and focusing on continuously enhancing my skills and adapting to new challenges in the feilds of cloud computing, software platform administration and development operations (DevOps).
            </p>
            <p>
